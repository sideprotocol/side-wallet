            ...
            >
              ...
              {/* <Row relative full justifyBetween color={'white'}>
                <a
                  ...
                  rel="noreferrer">
                  {formatAddress(accountUtxo?.txid || '-', 6)}
                </a>

                <Typography className="w-1/3 text-center">{accountUtxo?.vout || '-'}</Typography>
                <Typography className="w-1/3 text-right">
                  {' '}
            ...
            <Column relative rounded classname="bg-[#2C3138] p-2 py-3">
              {isDeposit ? (
                <>
                  ...
                  <DetailRow text={'Bridge Fee'} value={'0 BTC'}></DetailRow>
