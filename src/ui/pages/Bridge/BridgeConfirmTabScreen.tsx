            ...
            <Column relative rounded classname="bg-[#2C3138] p-2 py-3">
              {isDeposit ? (
                <>
                  ...
                  <DetailRow text={'Bridge Fee'} value={isDeposit ? '0.0001 BTC' : '0.00002 sBTC'}></DetailRow>

                  <DetailRow
                    text={'You will receive'}
                    value={
                      <div className="flex items-center text-right">
                        {isBtcBridge ? yourReceive : bridgeAmount}{' '}
                        {isBtcBridge ? (isDeposit ? 'sBTC' : 'BTC') : bridgeAsset?.asset.symbol}
                      </div>
                    }></DetailRow>
                </>
              ) : (
                <>
                  <DetailRow
                    ...
                    value={
                      <>
                        {withdrawFee} {isDeposit ? 'BTC' : 'sBTC'}{' '}
                        <img
                          src={
