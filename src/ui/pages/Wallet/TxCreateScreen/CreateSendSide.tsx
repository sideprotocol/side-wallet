...
export default function CreateSendSide() {
    ...
    const {data: feeByUSD} = useCalcPrice(uiState.fee || '0', feeToken?.asset?.denom, feeToken?.asset?.exponent || 6);
                ...
                >
                    ...
                    <Row>
                        <Text
                            ...
                            text={`${disabled ? '-' : toReadableAmount(uiState.fee, feeToken?.asset?.exponent)} ${feeToken?.asset?.symbol}`}
                            style={{
                                fontSize: '16px',
                                fontWeight: 600,
                                lineHeight: '24px'
