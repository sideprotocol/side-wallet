...
export const BRIDGE_ASSETS_TEST: IBridgeAsset = {
  [NOBLE_TEST_ID]: {
    [SIDE_TEST_ID]: {
      assets: [SIDE_TEST_ASSETLIST.Btct, SIDE_TEST_ASSETLIST.Side, SIDE_TEST_ASSETLIST.Usdc_ibc_noble]
    },
    [NOBLE_TEST_ID]: {
  ...
  [AXELAR_TEST_ID]: {
    ...
    [AXELAR_TEST_ID]: {
      assets: [AXELAR_TEST_ASSETLIST.Ausdc, AXELAR_TEST_ASSETLIST.Side_ibc_side]
    }
  },
  [BABYLON_TEST_ID]: {
    [SIDE_TEST_ID]: {
    ...
    [BABYLON_TEST_ID]: {
      assets: [BABYLON_TEST_ASSETLIST.Bbn, BABYLON_TEST_ASSETLIST.Side_ibc_side]
    }
  }
};
