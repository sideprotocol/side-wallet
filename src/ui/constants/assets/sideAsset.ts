// import Wbtc from "/images/icons/swap/wbtc.jpg";
// import Btct from "/images/icons/swap/btct.svg";
...
export const SIDE_DEV_ASSETLIST: { [key: string]: IAsset } = {
  // native token
  Side: {
    base: "uside",
    symbol: "SIDE",
  ...
  Eth: {
    base: "ueth", // smallest unit -> uatom -> ATOM
    symbol: "ETH", // currency name
    name: "Ethereum",
    exponent: "6", // The conversion ratio between the smallest unit and the display unit 10^18
    coingecko_id: "ethereum", // Get the ID of the currency market price from cg
...
export const SIDE_TEST_ASSETLIST: { [key: string]: IAsset } = {
  ...
  Btct: {
    base: "abtct", // smallest unit -> uatom -> ATOM
    symbol: "BTCT", // currency name
    name: "Bitcoin Token",
    exponent: "8", // The conversion ratio between the smallest unit and the display unit 10^18
    coingecko_id: "bitcoin", // Get the ID of the currency market price from cg
    logo: '/images/icons/swap/btct.svg',
    precision: 8,
  },
  Usdc: {
    base: "uusdc",
  ...
  Wbtc: {
    ...
    exponent: "8",
    logo: '/images/icons/swap/wbtc.jpg',
    name: "Wrapped BTC",
    precision: 8,
    symbol: "wBTC",
  },
...
export const SIDE_MAIN_ASSETLIST: { [key: string]: IAsset } = {
  // native token
  Side: {
    base: "uside",
    symbol: "SIDE",
