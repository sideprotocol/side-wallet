            ...
            <Column>
                ...
                <div className="flex bg-[#000] p-[16px] rounded-[8px]">
                    <Row onClick={() => {
                        ...
                        />
                        <div className="flex justify-center"  onMouseOver={handleMouseOver2}
                ...
                <div className={'flex items-center justify-center gap-[6px]'} onMouseOver={handleMouseOver} onMouseLeave={handleMouseLeave}
                  onClick={() => {
                    window.open(`${blockstreamUrl}/address/${address}`);
                  }}
                >
                  <Icon icon="eye" color={isHovered ? 'white' : 'textDim'} />
