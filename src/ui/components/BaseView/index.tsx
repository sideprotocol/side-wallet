...
export function BaseView(props: BaseViewProps) {
  ...
  const $baseViewStyle = Object.assign(
    ...
    rounded ? ({ borderRadius: 14 } as CSSProperties) : {},
    roundedTop ? ({ borderTopLeftRadius: 14, borderTopRightRadius: 14 } as CSSProperties) : {},
    roundedBottom ? ({ borderBottomLeftRadius: 14, borderBottomRightRadius: 14 } as CSSProperties) : {},
