...
export function BaseView(props: BaseViewProps) {
  ...
  const $baseViewStyle = Object.assign(
    ...
    rounded ? ({ borderRadius: 8 } as CSSProperties) : {},
    roundedTop ? ({ borderTopLeftRadius: 8, borderTopRightRadius: 8 } as CSSProperties) : {},
    roundedBottom ? ({ borderBottomLeftRadius: 8, borderBottomRightRadius: 8 } as CSSProperties) : {},
